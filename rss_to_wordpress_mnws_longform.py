...
if __name__ == "__main__":
    import sys
    date_input = input("Geef een datum in (JJJJ-MM-DD) of druk Enter voor vandaag: ").strip()
    selected_date = datetime.strptime(date_input, "%Y-%m-%d").date() if date_input else datetime.today().date()
    process_all(DEFAULT_FEEDS, selected_date)